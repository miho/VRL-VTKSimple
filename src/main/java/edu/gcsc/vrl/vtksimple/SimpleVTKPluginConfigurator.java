 ...
 */
public class SimpleVTKPluginConfigurator extends VPluginConfigurator{

    public SimpleVTKPluginConfigurator() {
        //specify the plugin name and version
       setIdentifier(new PluginIdentifier("VRL-VTKSimple", "0.1"));
       ...
       //
       exportPackage("edu.gcsc.vrl.vtksimple");

       // describe the plugin
       setDescription("VRL-VTKSimple");
